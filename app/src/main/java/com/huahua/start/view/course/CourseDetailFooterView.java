package com.huahua.start.view.course;
...
import com.huahua.start.module.course.CourseFooterDateValue;
import com.huahua.start.module.course.CourseFooterRecommandValue;
import com.huahua.start.module.course.CourseFooterValue;
import com.huahua.start.util.DateFormatHelper;
        ...
        for (int i = 0; i < mFooterValue.recommand.size(); i++) {
            ...
            mImageViews[i].setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    // 本来这个view是用在CourseDetailActivity里的
                    // 现在点击跳转的也是CourseDetailActivity

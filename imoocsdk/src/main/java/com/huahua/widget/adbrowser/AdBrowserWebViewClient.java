package com.huahua.widget.adbrowser;
...
public class AdBrowserWebViewClient extends WebViewClient {
    ...
    public AdBrowserWebViewClient(Listener listener) {
        if (listener == null) {
            Logger.info(LOG_TAG, "Error: Wrong listener");
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        Logger.info(LOG_TAG, "shouldOverrideUrlLoading url=" + url);
